...
public record LetterRequest(
	...
	@ValidUuid @Schema(description = "Party ID of the recipient", examples = "7ca29702-a07f-4e13-a66a-4ebc27929cfd", requiredMode = REQUIRED) String partyId,

	@NotBlank @Schema(description = "Subject of the letter", examples = "Important Notification", requiredMode = REQUIRED) String subject,
