...
public enum Queue {
	...
	SEND_DIGITAL_REGISTERED_LETTER(POST_PORTAL_SERVICE_EXCHANGE, SEND_DIGITAL_REGISTERED_LETTER_QUEUE),
	STATUS_DIGITAL_REGISTERED_LETTER(DIGITAL_REGISTERED_LETTER_EXCHANGE, STATUS_DIGITAL_REGISTERED_LETTER_QUEUE);
