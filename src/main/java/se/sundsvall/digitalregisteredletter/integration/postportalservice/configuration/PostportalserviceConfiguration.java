...
@EnableConfigurationProperties(PostportalserviceProperties.class)
public class PostportalserviceConfiguration {

	public static final String CLIENT_ID = "postportalservice";

	@Bean
	FeignBuilderCustomizer feignBuilderCustomizer(final PostportalserviceProperties postportalserviceProperties, final ClientRegistrationRepository clientRegistrationRepository) {
