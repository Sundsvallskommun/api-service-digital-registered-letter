...
public interface KivraClient {
	...
	/**
	 * This resource is used to send content to Kivra. The request body contains the content to be sent, and the response will contain the content that was sent.
	 *
	 * @param content the content to be sent to Kivra, encapsulated in a ContentUserV2 object
	 * @return a ResponseEntity containing a ContentUser object, which includes the subject, type and generated_at of the content sent by Kivra to the end user.
	 */
	...
	/**
	 * This resource is used to match a list of users to check that they are eligible for receiving Content from the specific Tenant. The request contains a list of recipient SSNs to be matched, and the response is a filtered list containing only the SSNs
	 * that are eligible to receive content from the tenant. If none of the provided SSNs are eligible to receive content from this tenant, an empty list will be returned.
	 *
	...
	/**
	 * This resource is used to retrieve the responses of all registered letters sent by the tenant that have been signed or expired. The response key can then be used to fetch the response details of each registered letter. The resource returns a list of
	...
	/**
	 * This resource is used to delete a specific registered letter response after we have updated the status of the letter in our system.
	 *
