...
class KivraConfigurationTest {
	...
	void testFeignBuilderCustomizer() {
		final var configuration = new KivraConfiguration();
		...
		try (final MockedStatic<FeignMultiCustomizer> feignMultiCustomizerMock = Mockito.mockStatic(FeignMultiCustomizer.class)) {
			...
			final ArgumentCaptor<JsonPathErrorDecoder> errorDecoderCaptor = ArgumentCaptor.forClass(JsonPathErrorDecoder.class);
